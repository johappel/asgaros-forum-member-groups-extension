...
- Erweiterungspunkte (`afspaces_hub_navigation_tabs`, `afspaces_render_space_creation`, Option/Filter `afspaces_enable_space_creation`) bereiten die MVP-4-Arbeitsgruppengründung vor, ohne sie sichtbar zu aktivieren. MVP 3.2 stellt diese Punkte bereits bereit, MVP 4 implementiert die tatsächliche Gründungslogik.
