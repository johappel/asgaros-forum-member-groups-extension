	...
	class CreateSpaceView {
		...
		public static function visibility_description( string $visibility ): string {
			switch ( $visibility ) {
				...
				case SpaceCreationSettings::VISIBILITY_PROTECTED:
					return __( 'Alle angemeldeten Personen auf dieser Plattform können die Beiträge und Themen lesen (aber nicht verfassen). Sie werden dadurch nicht automatisch Mitglieder der Arbeitsgruppe. Schreiben können nur Personen mit den dafür vorgesehenen Rechten.', 'afspaces' );
				case SpaceCreationSettings::VISIBILITY_PRIVATE:
				default:
